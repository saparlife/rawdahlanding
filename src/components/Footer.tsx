          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-2 text-[var(--text-primary)] hover:text-emerald-500 transition-colors font-medium"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[var(--text-muted)] hover:text-emerald-500 transition-colors text-sm"
              >
                Web App
              </a>
            </div>
