...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-4 py-2 rounded-full text-sm font-medium mb-6 backdrop-blur-sm"
            >
            ...
            >
              ...
              <a
                href="#features"
                className="inline-flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all border border-white/10 hover:border-white/20 backdrop-blur-sm"
              >
                {t('learnMore')}
              </a>
            </motion.div>
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-white text-black px-5 py-3 rounded-xl hover:bg-gray-100 transition-all hover:scale-105"
              >
              ...
              <div className="inline-flex items-center gap-3 bg-white/10 text-gray-400 px-5 py-3 rounded-xl cursor-not-allowed border border-white/10">
                <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
