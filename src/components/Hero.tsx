          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-3 bg-[var(--text-primary)] text-[var(--background)] px-6 py-4 rounded-2xl hover:opacity-90 transition-all hover:scale-105 shadow-lg"
              >
